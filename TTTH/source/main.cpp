...
int main(int argc, char *argv[])
{
    ...
    app.setWindowIcon(QIcon(":/resource/images/logo.jpg"));

    /** Initializing splash screen for the application */
    QSplashScreen *splash = new QSplashScreen;
    QImage *splashImage = new QImage(":/resource/images/SplashScreen.jpg");
    *splashImage = splashImage->scaledToHeight(300);
    ...
    sleep(2);
    splash->showMessage(QObject::tr("Loading trained files..."),topRight, Qt::black);
    sleep(1);
    splash->showMessage(QObject::tr("Starting interface..."),topRight, Qt::black);
    sleep(1);
